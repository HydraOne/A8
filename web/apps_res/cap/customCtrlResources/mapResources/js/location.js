...
//            dynamicLoading.js("http://api.map.baidu.com/getscript?v=2.0&ak=59xkhaYrPrauvvubXjGWZKqGiZi5amKP&services=&t=20190123111209");
        ...
        location: function (privateId, messageObj, adaptation) {
            ...
            //自定义控件   佘海涛  start
                //field0004合同名称，formmain_0048表名，field0064本次付款总额为
            const htNameValue = data.formmains.formmain_0048.field0004.value;
            const fkMoneyValue = data.formmains.formmain_0048.field0064.value;
            let message;
