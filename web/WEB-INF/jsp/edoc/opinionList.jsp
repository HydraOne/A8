...
<script type="text/javascript" src="${path}/ajax.do?managerName=OpinionListManagerImpl"></script>
...
$(document).ready(function() {
	...
	grid = $('#purchPlanList').ajaxgrid({		
		...
		height : tableHeight,
		customize:false,
		managerName : "OpinionListManagerImpl",
...
function showMessageBox0(id,opinion) {
    dialog = $.dialog({
        id: 'url',
        url: '/seeyon/opinionController.do?method=updateOpinion',
        width: 400,
        height: 250,
        title: '修改意见',
